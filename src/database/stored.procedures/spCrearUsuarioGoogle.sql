...
BEGIN
    ...
    INSERT INTO [desarmadero].[dbo].[Usuarios] (USR_NOMBRE, USR_APELLIDO, USR_EMAIL, USR_UID, USR_DIRECCION, USR_TELEFONO, USR_ROL, USR_ALTURA, USR_CIUDAD, USR_ACTIVO)
    VALUES (@p_USR_NOMBRE, @p_USR_APELLIDO, @p_USR_EMAIL, @p_USR_UID, @p_USR_DIRECCION, @p_USR_TELEFONO, @v_USR_ROLID, @p_USR_ALTURA, @p_USR_CIUDAD, 1);
